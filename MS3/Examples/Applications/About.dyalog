...
⍝ Description:: Introduction to MiServer 3.0 with links to external and Dyalog-provided resources
    ...
    ⍝  At the same time, it showcases many of MiServer's capabilities, as it is built almost entirely in
    ⍝  APL using components available in MiServer.
     
      ('src=../Data/Dyalog-D.png' 'alt="Dyalog-D"' 'height="20px"' 'style="vertical-align:bottom;"')(Add _.p ScriptFollows).Add _.img
