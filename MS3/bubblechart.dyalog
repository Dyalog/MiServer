:Class bubblechart : Dyalog14
    ...
    ∇ r←GetCIAData;stats;data
      ...
      stats←(20↑1 #.Files.FREAD _Request.Server.Config.AppRoot,'Data\stats')[;1 2 3 5]
      stats[;4]←⌊0.5+stats[;4]
      r←'text' 'y' 'size' 'x' 'fill'#.JSON.formatData stats,(≢stats)⍴'Navy' 'Coral' 'Crimson' 'Red' 'Fuchsia' 'Purple' 'OrangeRed'
    ∇
