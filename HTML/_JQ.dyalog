...
⍝ --- Base Classes ---
    :class _jqObject : #.HtmlElement
        ...
        :field public shared readonly True←{⍵⊣⍵.⎕DF'true'}⎕NS ''     ⍝ same definition as in #.JSON
        :field public shared readonly False←{⍵⊣⍵.⎕DF'false'}⎕NS ''   ⍝ same definition as in #.JSON
    ...
    :class _jqTabbedWidget : _jqWidget
        :field public Titles←''
        :field public Id←''
        :field public Tabs←''
        :field public Widget
