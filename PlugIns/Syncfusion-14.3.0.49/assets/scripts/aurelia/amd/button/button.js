define(['exports', '../common/common', 'ej.button.min'], function (exports, _common) {
  'use strict';
  ...
  var ejButton = exports.ejButton = (_dec = (0, _common.customAttribute)(_common.constants.attributePrefix + 'button'), _dec2 = (0, _common.generateBindables)('ejButton', ['contentType', 'cssClass', 'enabled', 'enableRTL', 'height', 'htmlAttributes', 'imagePosition', 'prefixIcon', 'repeatButton', 'showRoundedCorner', 'size', 'suffixIcon', 'text', 'timeInterval', 'type', 'width'], [], { 'enableRTL': 'enableRtl' }), _dec3 = (0, _common.inject)(Element), _dec(_class = _dec2(_class = _dec3(_class = function (_WidgetBase) {
