...
export interface LayersLegendSettings {
	...
	*   @Default {default}
	*/
	LegendMode?: ej.datavisualization.Map.LegendMode|string;
...
export interface ConnectorsLabels {
...
export interface SelectedItemsUserHandles {
...
export interface SelectedItems {
	...
	*   @Default {[]}
	*/
	userHandles?: Array<SelectedItemsUserHandles>;
