...
declare module "ej/button.component" {
    ...
    export var ButtonValueAccessor: Type;
...
declare module "ej/diagram.component" {
    ...
    export const EJ_DIAGRAM_COMPONENTS: Type[];
}
...
declare module "ej/map.component" {
    ...
    export const EJ_MAP_COMPONENTS: Type[];
}
...
declare module "ej/navigationdrawer.component" {
    import { Type } from "ej/core";
    export var NavigationDrawerComponent: Type;
    export const EJ_NAVIGATIONDRAWER_COMPONENTS: Type[];
}
...
declare module "ej/pivotchart.component" {
    import { Type } from "ej/core";
    export var PivotChartComponent: Type;
    export const EJ_PIVOTCHART_COMPONENTS: Type[];
}
declare module "ej/pivotgauge.component" {
    import { Type } from "ej/core";
    export var PivotGaugeComponent: Type;
    export const EJ_PIVOTGAUGE_COMPONENTS: Type[];
}
...
declare module "ej/radialslider.component" {
    import { Type } from "ej/core";
    export var RadialSliderComponent: Type;
    export const EJ_RADIALSLIDER_COMPONENTS: Type[];
}
...
declare module "ej/sparkline.component" {
    import { Type } from "ej/core";
    export var SparklineComponent: Type;
    export const EJ_SPARKLINE_COMPONENTS: Type[];
}
...
declare module "ej/tile.component" {
    import { Type } from "ej/core";
    export var TileComponent: Type;
    export const EJ_TILE_COMPONENTS: Type[];
}
...
declare module "ej/treemap.component" {
    ...
    export const EJ_TREEMAP_COMPONENTS: Type[];
}
...
declare module "ej/uploadbox.component" {
    import { Type } from "ej/core";
    export var UploadboxComponent: Type;
    export const EJ_UPLOADBOX_COMPONENTS: Type[];
}
declare module "ej/web.all" {
    ...
    export var EJ_DIAGRAM_COMPONENTS: Type[];
    ...
    export var EJ_SPARKLINE_COMPONENTS: Type[];
    ...
    export var EJ_UPLOADBOX_COMPONENTS: Type[];
}
