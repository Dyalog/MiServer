    ...
    ∇ Render req;style;html;sections;cart;catalog;cartOptions;id
      ...
      :If req.IsAPLJax
          :If 0<⍴id←req.GetData'drag'
              req.Response.(NoWrap HTML)←1(AddToCart id)
          :EndIf
      :Else
          :If ~0∊⍴mycart
          :AndIf 'Buy '≡4↑Action
          ...
          style←'#products'MakeStyle'float' 'left' 'width' '500px' 'height' '350px' 'margin-right' '2em'
          ...
          catalog,←req #.JQUI.Tabs'catalog'categories sections
